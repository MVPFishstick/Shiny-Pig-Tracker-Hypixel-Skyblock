...
LOG_PATH = Path(os.environ.get("MC_LOG",
    Path.home() / "AppData" / "Roaming" / "ModrinthApp" /
    "profiles" / "SkyBlock Enhanced - Modern Edition" / "logs" / "latest.log"))
PORT = 7878

state = {
    "events": [], "bazaar": {}, "display_lookup": {},
...
def tail_log():
    ...
    if not LOG_PATH.exists():
        print(f"[log] WARNING: file not found — {LOG_PATH}")
    # Wait until both bazaar and items data are loaded
